...
insert into board_tb(title, content, user_id, created_at) values ('제목7', '내용7', 3, now());
insert into board_tb(title, content, user_id, created_at) values ('제목8', '내용8', 3, now());
insert into board_tb(title, content, user_id, created_at) values ('제목9', '내용9', 3, now());
...
insert into board_tb(title, content, user_id, created_at) values ('제목13', '내용13', 1, now());
insert into board_tb(title, content, user_id, created_at) values ('제목14', '내용14', 1, now());
insert into board_tb(title, content, user_id, created_at) values ('제목15', '내용15', 1, now());
insert into board_tb(title, content, user_id, created_at) values ('제목16', '내용16', 1, now());
insert into board_tb(title, content, user_id, created_at) values ('제목17', '내용17', 2, now());
